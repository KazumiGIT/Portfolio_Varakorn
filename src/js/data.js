...
export const profile = {
  ...
  roleSecond: 'AI Digital Marketing',
...
export const timeline = [
  ...
  },
  {
    ...
    role: 'JomHack Free Python Bootcamp',
    page: '/experience/jomhack-python-bootcamp',
    story:
      'The pivot. Late one November night, a TikTok live by Mr Inbaraj promoted a free Python bootcamp by JomHack. The December slots were full, then suddenly were not, and I applied on the spot. Python fundamentals and AI agent integration by night, and halfway through, the same lives pointed me to Gamuda AI Academy.',
  },
  {
    year: '2026',
...
export const experience = [
  ...
  },
  {
    ...
    page: '/experience/gamuda-ai-academy',
    points: [
      'Team lead of group JAAVIS: led the Tendervise AI capstone, tender document analysis with ESG scoring agents targeting a 50% efficiency gain.',
      'One of two teams out of seven selected to present to YB Datuk Chang Lih Kang, Minister of Science, Technology and Innovation (MOSTI).',
      'Three intense months: full stack and AI engineering fundamentals by morning, capstone by afternoon, plus visits to Google HQ and Gamuda HQ.',
    ],
    card: {
      no: '005',
      type: 'ENGINEER',
  ...
  },
  {
    ...
    role: 'JomHack Free Python Bootcamp',
    period: 'Dec 2025',
    place: 'Online · Malaysia',
    page: '/experience/jomhack-python-bootcamp',
    points: [
      'Python fundamentals and AI agent integration, shipped nightly as small scripts that automated corners of my life.',
      'Found through Mr Inbaraj’s TikTok lives promoting free tech education for Malaysians.',
      'The starting point that led directly to a seat at Gamuda AI Academy one month later.',
    ],
    card: {
      no: '004',
      type: 'PIVOT',
      accent: 'red',
      art: 'monitor',
      flavor: 'Trigger card. One TikTok live rewrites the entire deck.',
      stats: [
        { k: 'Program', v: 'JomHack · free' },
        { k: 'Found via', v: 'A TikTok live' },
        { k: 'Unlocked', v: 'Gamuda AI Academy' },
      ],
    },
  },
  {
