...
export const Overlay = () => {
    ...
    return (
        ...
        >
            {/* Section 0: Hero */}
            <section className="h-screen w-screen flex flex-col justify-center items-start p-10 md:p-24 max-w-4xl">
                <div className="space-y-6 animate-fade-in">
                    ...
                    <h1 className="text-7xl md:text-9xl font-bold text-white mb-4 tracking-tighter leading-none">
                        Hello,
                        <br />
                    ...
                    <div className="flex flex-wrap gap-3 mt-8">
                        <div className="px-4 py-2 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                            <span className="text-gray-400 text-sm">🎓 IT Software Developer</span>
                        </div>
                        <div className="px-4 py-2 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                            <span className="text-gray-400 text-sm">🎥 Content Creator</span>
                        </div>
                        <div className="px-4 py-2 bg-white/5 backdrop-blur-sm rounded-lg border border-white/10">
                            <span className="text-gray-400 text-sm">🤖 AI Marketing</span>
                        </div>
                    </div>
            ...
            {/* Section 1: Timeline */}
            <section className="min-h-screen w-screen flex flex-col justify-center items-center p-10 md:p-24">
                <div className="max-w-5xl w-full space-y-12">
                    <h2 className="text-5xl md:text-7xl font-bold text-white mb-8 tracking-tight text-center">
                        My Journey
                    </h2>

                    <p className="text-xl text-gray-300 text-center max-w-2xl mx-auto mb-16 leading-relaxed">
            ...
            <section className="min-h-screen w-screen flex flex-col justify-center items-center p-10 md:p-24 bg-gradient-to-b from-black via-pink-900/10 to-black">
                <div className="max-w-7xl w-full space-y-12">
                    {/* Header */}
                    <div className="text-center space-y-6">
                        <div className="inline-block px-6 py-2 bg-pink-500/20 rounded-full border border-pink-500/30 mb-4">
                            <span className="text-pink-300 text-sm font-medium">2023 - 2025 • Editor Intern → Full-Time Content Creator</span>
                        </div>
            ...
            {/* Section 4: Contact */}
            <section className="min-h-screen w-screen flex flex-col justify-center items-center p-10 md:p-24 text-center">
